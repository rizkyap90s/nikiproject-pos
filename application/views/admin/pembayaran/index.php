    ...
    <div class="container mt-5">
        ...
        <div class="row">
                    ...
                    <div class="card mt-4 card-rounded">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" value="<?= $edit->pembayaran;?>"
                                    name="pembayaran" id="pembayaran" placeholder="">
                            </div>
                            <input type="hidden" name="id" value="<?= $edit->id;?>">
                            <?php }else{?>
                            <div class="form-group">
                                <label for="">Nama pembayaran</label>
                                <input type="text" required class="form-control" name="pembayaran" id="pembayaran"
                                    placeholder="">
                            </div>
                            <?php }?>
                        </div>
                        <div class="card-footer text-muted">
                            <div class="float-right">
                                ...
                                if (!empty($id)) {
                                    // Your code here
                                ?>
                                <a href="<?= base_url('pembayaran');?>" class="btn btn-danger btn-md">
            ...
            <div class="col-sm-8">
                <div class="card mt-4 card-rounded">
                    <div class="card-header bg-primary text-white">
                        <i class="fa fa-tags"></i> pembayaran
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($r->id > 1){?>
                                            <a href="<?= base_url('pembayaran/delete?id='.$r->id);?>"
                                                class="btn btn-danger btn-sm"
                                                onclick="javascript:return confirm('Apakah pembayaran ingin dihapus ?')">
